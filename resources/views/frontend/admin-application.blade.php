        ...
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <h5 class="card-title mb-2 mb-md-0">All Applicants</h5>
                    <div class="d-flex flex-column flex-md-row align-items-center">
                        <form class="d-flex align-items-center me-0 me-md-3 mb-2 mb-md-0" method="GET" action="{{ route('admin.applications') }}">
                            <input type="text" class="form-control me-2" name="search" placeholder="Search by NIC, Passport, Application No, or Email" value="{{ request('search') }}" style="width: 200px; min-width: 150px;">
                        ...
                        <form class="d-flex align-items-center mb-2 mb-md-0" method="GET" action="{{ route('admin.applications') }}">
