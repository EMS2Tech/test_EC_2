                                    ...
                                    <div class="mb-0 p-0 p-lg-3">
                                        ...
                                        <div class="mb-0 border-0 p-md-4 p-lg-0">
                                            ...
                                            <div class="d-flex gap-2 align-items-center mb-3">
                                                <div class="lh-1">
                                                    <span class="">
                                                        <img src="{{ asset('frontend/assets/images/users/user-14.jpg') }}"
                                                            alt="" class="avatar avatar-sm rounded-circle me-1">
                                                    </span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="pt-0">
                                                <form action="https://zoyothemes.com/hando/html/index.html"
                                                    class="mt-4 mb-3">
