        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <img src="frontend/assets/images/small/user-image.jpg" class="rounded-top-2 img-fluid"
                                alt="image data">
                                ...
                                <div class="align-items-center">
                                    ...
                                    <div class="hando-main-sections">
                                        <div class="hando-profile-main">
                                            <img src="frontend/assets/images/users/user-11.jpg"
                        ...
                        <div class="card">
                            <div class="card-body pt-0">
                                <ul class="nav nav-underline border-bottom pt-2" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link p-2" id="friend_tab" data-bs-toggle="tab" href="#friends_setting"
                                            role="tab">
                                ...
                                <div class="tab-content text-muted">
                                    <div class="tab-pane active show pt-4" id="profile_about" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-md-6 mb-4">
                                                <div class="">
                                                    <h5 class="fs-16 text-dark fw-semibold mb-3 text-capitalize">About me
                                                    </h5>
                                                ...
                                                <div class="skills-details mt-3">
                                                    ...
                                                    <div class="d-flex flex-wrap gap-2">
                                                        ...
                                                        <span class="badge bg-light px-3 text-dark py-2 fw-semibold">User
                                                            Experience</span>
                                                        <span
                                                            class="badge bg-light px-3 text-dark py-2 fw-semibold">Interaction
                                                            Design </span>
                                                        <span class="badge bg-light px-3 text-dark py-2 fw-semibold">3D
                                                            Design</span>
                                                        <span
                                                            class="badge bg-light px-3 text-dark py-2 fw-semibold">Information
                                                            Architecture</span>
                                                        <span class="badge bg-light px-3 text-dark py-2 fw-semibold">User
                                                            Research</span>
                                                        <span
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-md-6 mb-0">
                                                <div class="">
                                                    <h5 class="fs-16 text-dark fw-semibold mb-3 text-capitalize">Projects
                                                    </h5>
                                                </div>
                                                        ...
                                                        <div class="card border">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row mt-2 d-flex align-items-center">
                                                                    ...
                                                                    <div class="col-auto">
                                                                        <a href="#"
                                                                            class="btn btn-sm btn-outline-primary px-3">More
                                                                            Details</a>
                                                                    </div>
                                                                </div>
                                                            </div><!--end card-body-->
                                            ...
                                            <div class="col-md-6 col-sm-6 mb-0">
                                                <div class="">
                                                    <h5 class="fs-16 text-dark fw-semibold mb-3 text-capitalize">Expertise
                                                    </h5>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-lg-6">
                                                    <ol class="profile-section list-unstyled mb-md-0 px-4">
                                                        ...
                                                        <li class="profile-item">
                                                            ...
                                                            <div class="exper-item-list">
                                                                <div>
                                                                    <h5 class="font-size-16 mb-1">VP, Product Management
                                                                    </h5>
                                                                    <div class="list-inline list-inline-dots mb-1 fs-14">
                                                        ...
                                                        <li class="profile-item pb-0">
                                                            ...
                                                            <div class="exper-item-list">
                                                                <h5 class="font-size-16 mb-1">Director, Product Management
                                                                </h5>
                                                                <div class="list-inline list-inline-dots mb-1 fs-14">
                                    ...
                                    <div class="tab-pane pt-4" id="profile_education" role="tabpanel">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-lg-6">
                                                <h5 class="fs-16 text-dark fw-semibold mb-3 text-capitalize">My Education
                                                </h5>
                                            </div>
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <ol class="profile-section list-unstyled mb-0 px-4">
                                                        <li class="profile-item">
                                                            ...
                                                            <div class="exper-item-list">
                                                                <h5 class="fs-16 text-dark">Bogazicied Technic University
                                                                </h5>
                                                    ...
                                                    <div class="card border">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <form class="needs-validation" novalidate>
                                                                ...
                                                                <!-- Name with Initials -->
                                                                <div class="mb-3">
                                                                    <label for="initials" class="form-label">Name With
                                                                        Initials</label>
                                                                ...
                                                                <!-- Birth Day -->
                                                                <div class="mb-3">
                                                                    <label for="birthDay" class="form-label">Birth
                                                                        Day</label>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <small id="photoHelp"
                                                                        class="form-text text-muted">Capital Block
                                                                        Letters</small>
                                                                </div>
                                                                <!-- Contact Phone -->
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="col-lg-12 col-xl-12">
                                                                        <div class="input-group has-validation">
                                                                            ...
                                                                            <input class="form-control" type="tel"
                                                                                name="contactPhone" placeholder="07XXXXXXXX"
                                                                                required pattern="^07[0-9]{8}$">
                                                                            <div class="invalid-feedback">Enter a valid
                                                                                phone number starting with 07 and 10 digits
                                                                                total.</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-lg-12 col-xl-12">
                                                                        <div class="input-group has-validation">
                                                                            ...
                                                                            <input class="form-control" type="tel"
                                                                                ...
                                                                                pattern="^07[0-9]{8}$">
                                                                            <div class="invalid-feedback">Enter a valid
                                                                                WhatsApp number starting with 07 and 10
                                                                                digits total.</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="card border">
                                                    <div class="card-body">
                                                        <div class="text-center">
                                                            ...
                                                            <div class="mt-2 mb-3">
                                                                <span
                                                                    class="badge bg-primary-subtle rounded-2 text-primary mb-2 fw-normal">Team
                                                                    Member</span>
                                                                <h5 class="m-0 fw-medium text-dark fs-16">Jimmy L. Keener
                                                                </h5>
                                                                <p class="mt-1 mb-0">JimmyLKeener@gmail.com</p>
                                                            </div>
                                                            <div class="">
                                                                <button type="button"
                                                                    class="btn btn-sm btn-light me-2">Block</button>
                                                                <button type="button"
                                                                    class="btn btn-sm btn-primary">Unfollow</button>
                                                            </div>
                                                        </div>
                                                    </div><!--end card-body-->
                                                </div>
                                            ...
                                            <div class="col-12 col-md-3">
                                                <div class="card border">
                                                    <div class="card-body">
                                                        <div class="text-center">
                                                            <img src="frontend/assets/images/users/user-3.jpg"
                                                                class="rounded-circle avatar-xl img-thumbnail"
                                                                alt="image profile">

                                                            <div class="mt-2 mb-3">
                                                                <span
                                                                    class="badge bg-dark-subtle rounded-2 text-dark mb-2 fw-normal">Team
                                                                    Member</span>
                                                                <h5 class="m-0 fw-medium text-dark fs-16">Paul D. Garner
                                                                </h5>
                                                            ...
                                                            <div class="">
                                                                <button type="button"
                                                                    class="btn btn-sm btn-light me-2">Block</button>
                                                                <button type="button"
                                                                    class="btn btn-sm btn-dark">Unfollow</button>
                                                            </div>
                                                        </div>
                                                    </div><!--end card-body-->
                                                </div>
                                            ...
                                            <div class="col-12 col-md-3">
                                                <div class="card border">
                                                    <div class="card-body">
                                                        <div class="text-center">
                                                            <img src="frontend/assets/images/users/user-5.jpg"
                                                                class="rounded-circle avatar-xl img-thumbnail"
                                                                alt="image profile">

                                                            <div class="mt-2 mb-3">
                                                                <span
                                                                    class="badge bg-secondary-subtle rounded-2 text-secondary mb-2 fw-normal">Team
                                                                    Member</span>
                                                                <h5 class="m-0 fw-medium text-dark fs-16">Dallas J. Miller
                                                                </h5>
                                                            ...
                                                            <div class="">
                                                                <button type="button"
                                                                    class="btn btn-sm btn-light me-2">Block</button>
                                                                <button type="button"
                                                                    class="btn btn-sm btn-secondary">Unfollow</button>
                                                            </div>
                                                        </div>
                                                    </div><!--end card-body-->
                                                </div>
                                            ...
                                            <div class="col-12 col-md-3">
                                                <div class="card border">
                                                    <div class="card-body">
                                                        <div class="text-center">
                                                            <img src="frontend/assets/images/users/user-8.jpg"
                                                                class="rounded-circle avatar-xl img-thumbnail"
                                                                alt="image profile">

                                                            <div class="mt-2 mb-3">
                                                                <span
                                                                    class="badge bg-danger-subtle rounded-2 text-danger mb-2 fw-normal">Team
                                                                    Member</span>
                                                                <h5 class="m-0 fw-medium text-dark fs-16">Kristin R. Hunter
                                                                </h5>
                                                            ...
                                                            <div class="">
                                                                <button type="button"
                                                                    class="btn btn-sm btn-light me-2">Block</button>
                                                                <button type="button"
                                                                    class="btn btn-sm btn-danger">Unfollow</button>
                                                            </div>
                                                        </div>
                                                    </div><!--end card-body-->
                                                </div>
                                            ...
                                            <div class="col-12 col-md-3">
                                                <div class="card border mb-md-0">
                                                    <div class="card-body">
                                                        <div class="text-center">
                                                            <img src="frontend/assets/images/users/user-9.jpg"
                                                                class="rounded-circle avatar-xl img-thumbnail"
                                                                alt="image profile">

                                                            <div class="mt-2 mb-3">
                                                                <span
                                                                    class="badge bg-secondary-subtle rounded-2 text-secondary mb-2 fw-normal">Android
                                                                    Developer</span>
                                                                <h5 class="m-0 fw-medium text-dark fs-16">Jacqueline M. Dunn
                                                                </h5>
                                                        ...
                                                        <div class="text-center">
                                                            ...
                                                            <div class="mt-2 mb-3">
                                                                <span
                                                                    class="badge bg-primary-subtle rounded-2 text-primary mb-2 fw-normal">Team
                                                                    Member</span>
                                                                <h5 class="m-0 fw-medium text-dark fs-16">Ricky V. Johnson
                                                                </h5>
                                            ...
                                            <div class="col-12 col-md-3">
                                                <div class="card border mb-md-0">
                                                    <div class="card-body">
                                                        <div class="text-center">
                                                            <img src="frontend/assets/images/users/user-12.jpg"
                                                                class="rounded-circle avatar-xl img-thumbnail"
                                                                alt="image profile">

                                                            <div class="mt-2 mb-3">
                                                                <span
                                                                    class="badge bg-warning-subtle rounded-2 text-warning mb-2 fw-normal">Software
                                                                    Developer</span>
                                                                <h5 class="m-0 fw-medium text-dark fs-16">Kenneth S. Cormier
                                                                </h5>
                                                            ...
                                                            <div class="">
                                                                <button type="button"
                                                                    class="btn btn-sm btn-light me-2">Block</button>
                                                                <button type="button"
                                                                    class="btn btn-sm btn-info">Unfollow</button>
                                                            </div>
                                                        </div>
                                                    </div><!--end card-body-->
                                                </div>
                                                        ...
                                                        <div class="text-center">
                                                            ...
                                                            <div class="mt-2 mb-3">
                                                                <span
                                                                    class="badge bg-danger-subtle rounded-2 text-danger mb-2 fw-normal">Team
                                                                    Leader</span>
                                                                <h5 class="m-0 fw-medium text-dark fs-16">Evelyn J. Serra
                                                                </h5>
                                                            ...
                                                            <div class="">
                                                                <button type="button"
                                                                    class="btn btn-sm btn-light me-2">Block</button>
                                                                <button type="button"
                                                                    class="btn btn-sm btn-warning">Unfollow</button>
                                                            </div>
                                                        </div>
                                                    </div><!--end card-body-->
                                                </div>
