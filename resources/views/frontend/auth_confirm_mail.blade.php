                                    ...
                                    <div class="mb-0 p-0 p-lg-3">
                                        <div class="mb-0 border-0 p-md-4 p-lg-0">
                                            ...
                                            <div class="auth-title-section mb-4 text-center">
                                                ...
                                                <p class="text-muted fs-14 mb-0">Please check your email for confirmation
                                                    mail. <br>Click link in email to verification your account</p>
                                            </div>

                                            <div class="text-center">
                                                <a href="#" class="btn btn-primary mt-3 me-1" type="submit">Resend
                                                    Confirmation</a>
                                            </div>
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item">
                                        <p class="prelead mb-2">
                                            ...
                                            Pretty nice theme, hoping you guys could add more features to this. Keep up the
                                            good work.
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                viewBox="0 0 24 24">
                                                <path fill="#ffffff"
