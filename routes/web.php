...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/profile/export-application', [ProfileController::class, 'exportApplication'])->name('profile.export.application');
    ...
    Route::middleware(['auth', RestrictType::class . ':admin,course_manager,front_manager,finance_manager'])->group(function () {
